...
import { getGoals, saveGoals, completeGoal } from '../api/inventory';
import { getItSkills, getQualifications, getAdSeminars } from '../api/master';
import type { ItSkill, Qualification, AdSeminar } from '../types/master';
    ...
    <div className="goal-page">
      ...
      <main className="goal-main">
        ...
        <div className="goal-add-buttons">
          <button className="btn btn-secondary" onClick={() => addItSkillGoal(false)}>+ ITスキル目標</button>
          <button className="btn btn-secondary" onClick={() => addItSkillGoal(true)}>+ ITスキル目標（自由入力）</button>
          <button className="btn btn-secondary" onClick={() => addQualificationGoal(false)}>+ 資格目標</button>
          <button className="btn btn-secondary" onClick={() => addQualificationGoal(true)}>+ 資格目標（自由入力）</button>
          <button className="btn btn-secondary" onClick={addAdGoal}>+ AD目標</button>
        </div>
