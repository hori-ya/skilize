 ...
 * ----------------------------------------------------------------------------------------------------------
 * 機能概要：
 * 目標1件の保存コマンド。プレゼンテーション層からアプリケーション層へ目標データを伝達する。
 * ----------------------------------------------------------------------------------------------------------
 * 更新履歴：
...
/**
 * 目標1件の保存コマンド。InventoryService.saveGoals() に渡す。
 ...
 * @param reason         目標設定理由
 */
public record GoalCommand(Integer id, String goalCategory, Integer itSkillId,
