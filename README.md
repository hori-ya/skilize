...
エンジニアは何を学び、どこまで成長してきたか——その軌跡を記録し、次のキャリアへつなげるための社内スキル管理プラットフォームです。

ITスキル・資格・セミナー受講履歴を年次で蓄積し、チームリーダーとともにレビュー・目標設定まで一気通貫で行えます。  
さらに、蓄積されたデータを AI が分析し、その人のスキル傾向・成長領域・次のアクションをパーソナルなキャリアレポートとして提示します。
